    ...
    return (
        <>
            <div className="grid grid-cols-3 mx-2 mt-4 bg-gray-100 rounded-lg px-3 py-2">
                <label className="flex items-center" htmlFor="range">{t[lang].enterDate}</label>
            ...
            <div className="flex flex-col mx-2 mt-1 ">
                {
                    results === null ? (
                        ...
                        (<>
                            ...
                            <p className="text-center text-2xl text-gray-500 font-semibold">{t[lang].noDevices}</p>
                                ...
                                <div className="flex flex-col mx-2 mt-1">
                                    {results.map((e, i) => (
                                        <div key={i} className="grid grid-cols-3 px-3 py-3 border-b border-gray-100 hover:bg-gray-50 transition-colors ">
                                            ...
                                            <p className="text-sm text-gray-800 col-span-1">{getWorkingDuration(e.id)} {t[lang].days}</p>
