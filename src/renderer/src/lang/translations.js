export const t = {
    ...
    insuranceLabel: "did the client pay the insurance ( 2000 DA)",
    save: "Save",
    ...
    insuranceLabel: "هل دفع العميل التأمين ( 2000 دج )",
    save: "حفظ",
